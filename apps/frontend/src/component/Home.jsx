...
const Home = () => {
  ...
  // 파이 차트
  const [selectedDefectYear, setSelectedDefectYear] = useState(
    new Date().getFullYear()
  );
  const [selectedDefectMonth, setSelectedDefectMonth] = useState(
    new Date().getMonth() + 1
  );
                    ...
                    <FullCalendar
                      ...
                      events={events.map((event) => ({
                        ...event,
                          ...
                          ? new Date(
                              new Date(event.end).setDate(
                                new Date(event.end).getDate() + 1
                              )
                            )
                          : event.end,
                      }))}
                      ...
                      dayCellContent={(args) => {
                        return <div>{args.date.getDate()}</div>;
                      }}
                    />
                    <div className="my-3">
                ...
                <div id="print-content" ref={printRef}>
                  ...
                  <div className="card card-round">
                    ...
                    <div className="card-body flex-card-body">
                      <PieChart
                        year={selectedDefectYear}
                        month={selectedDefectMonth}
                        range={selectedDefectRange}
                      />
                    </div>
                  </div>
                </div>
