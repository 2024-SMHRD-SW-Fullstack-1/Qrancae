!(function (t, e) {
        ...
        value: function (t) {
          ...
          for (var e = Object(t), i = 1; i < arguments.length; i++) {
            ...
            if (null != s) {
              s = Object(s);
              for (
                var a = Object.keys(Object(s)), n = 0, r = a.length;
                n < r;
                n++
              ) {
                var o = a[n],
      ...
      getLabelText: function (t, e) {
        if (e) {
          if ('function' == typeof e.render) {
            var i = [];
            return (
              this.config && this.config.marker && i.push(this.config.marker),
              i.push(t),
          ...
          for (var a = 0; a < e.length; a++) {
            ...
            switch (this._series.config.attribute) {
              case 'fill':
                (t = e[a].value),
                  /\.(jpg|gif|png)$/.test(t)
                    ? (r.style.background = 'url(' + e[a].value + ')')
  ...
  var T = {
      ...
      _setupElementEvents: function () {
        ...
        S.on(a, 'mousemove', function (s) {
            ...
            'mouseover' === t.type
              ? (e.element.hover(!0),
                i &&
                  ...
                  s._tooltip.show(),
                  s._emit(e.event, [t, s._tooltip, e.code])))
          ...
          S.delegate(a, 'mouseup', '.jvm-element', function (t) {
            ...
            if (
              !i &&
              (('region' === e.type && s.params.regionsSelectable) ||
                ('marker' === e.type && s.params.markersSelectable))
            ) {
              var a = e.element;
      ...
      _setupZoomButtons: function () {
        ...
        var s = function (e) {
          return (
            ...
            function () {
              return t._setScale(
                e ? t.scale * t.params.zoomStep : t.scale / t.params.zoomStep,
                t._width / 2,
                t._height / 2,
                !1,
      ...
      _createRegions: function () {
        ...
        this._mapData.paths)) {
          ...
          this.regions[t] = { config: this._mapData.paths[t], element: e };
        }
      },
      ...
      _createMarkers: function (t, e) {
        ...
        var s = function () {
          ...
          var o = new O({
            index: a,
            map: i,
            style: v(i.params.markerStyle, { initial: s.style || {} }, !0),
        ...
        this._defaultWidth * this.scale <= this._width
          ? ((t =
            ...
            (i =
              ...
              (2 * this.scale)))
          : ((t = 0),
            (i = (this._width - this._defaultWidth * this.scale) / this.scale)),
            ...
            ? ((o = this.scale),
              ...
              (r = setInterval(function () {
                (g += 1),
                  ...
                  g == v &&
                    (clearInterval(r),
                    m._emit(k.onViewportChange, [m.scale, m.transX, m.transY]));
              }, 10)))
            : ((this.transX = d),
              (this.transY = f),
              (this.scale = t),
      ...
      setFocus: function (t) {
        ...
        if (
          ...
          return (
            ...
            this._setScale(
              Math.min(this._width / i.width, this._height / i.height),
              -(i.x + i.width / 2),
              -(i.y + i.height / 2),
              !0,
              t.animate,
      ...
      return (
        (e._init = function () {
          ...
          (this.container = f(t.selector)),
            ...
            t.visualizeData &&
              (this.dataVisualization = new V(t.visualizeData, this)),
            t.bindTouchEvents &&
        ...
        (e.removeLine = function (t, e) {
          ...
          this._lines.hasOwnProperty(i) &&
            (this._lines[i].element.remove(), delete this._lines[i]);
        }),
        (e.reset = function () {
          ...
          this.legendHorizontal &&
            (g(this.legendHorizontal), (this.legendHorizontal = null)),
            this.legendVertical &&
              (g(this.legendVertical), (this.legendVertical = null)),
  ...
  (G.maps = {}),
    (G.defaults = {
      ...
      zoomStep: 1.5,
      bindTouchEvents: !0,
      lineStyle: { stroke: '#808080', strokeWidth: 1, strokeLinecap: 'round' },
      markersSelectable: !1,
